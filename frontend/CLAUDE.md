https://www.cursorrules.org/article/expo-cursor-mdc-file?utm_source=cursorrules.org
...
- **Common Patterns and Anti-patterns**
  ...
  - **Best Practice**
    - Components should be shared as much as possible, e.g. Buttons, TextBoxes, etc. should have consistent style and behaviour.
